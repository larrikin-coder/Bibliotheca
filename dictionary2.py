...
def getinfo():
    ...
    def forgetpasswd():
                    ...
                    if cck == otpd:
                        ...
                        if nwpwd == nwpwd2:
                            try:
                                mycon = con.connect(host="localhost",user="root",passwd=mypwd,database='bibliotheca')
                                if mycon.is_connected():
                                    pyautogui.alert("connection to brain successful",'Message')
                                cur = mycon.cursor()
        ...
        window.destroy()
        root = tk.Tk()
        photo = tk.PhotoImage(file=r"C:\Users\SHAURYA\Desktop\school project 2.0\resources\pwd rst.png")
        root.iconphoto(False,photo)
    ...
    icon_photo = tk.PhotoImage(file=r"C:\Users\SHAURYA\Desktop\school project 2.0\resources\login.png")
    window.iconphoto(False, icon_photo)
    photo = tk.PhotoImage(file = r"C:\Users\SHAURYA\Desktop\school project 2.0\resources\ok.png")
    photo2 = tk.PhotoImage(file = r"C:\Users\SHAURYA\Desktop\school project 2.0\resources\forget pwd.png")
    lbl = tk.Label(text="user name:")
...
def Button_dict():
    ...
    ttk.Button(window,text="QUIT",command=quit).grid(column = 3,row = 4,pady = 10)#to quit the frame
...
def settings():
    ...
    photo = tk.PhotoImage(file=r"C:\Users\SHAURYA\Desktop\school project 2.0\resources\settings.png")
    window.iconphoto(False,photo)
        ...
        if mycon.is_connected():
            ...
            if m in a[0]:
                if n in b[0]:
                    ...
                    photo = PhotoImage(file = r"C:\Users\SHAURYA\Desktop\school project 2.0\resources\dictionary.png")
                    root.iconphoto(False,photo)
                    bg_img = PhotoImage(file=r"C:\Users\SHAURYA\Desktop\school project 2.0\resources\bg.png")
